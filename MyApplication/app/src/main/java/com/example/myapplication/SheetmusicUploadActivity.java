...
public class SheetmusicUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "업로드 onCreate", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(this, "업로드 onStart", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onResume() {
        ...
        Toast.makeText(this, "업로드 onResume", Toast.LENGTH_SHORT).show();
    ...
    protected void onRestart() {
        super.onRestart();
        Toast.makeText(this, "업로드 onRestart", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onPause() {
        super.onPause();
        Toast.makeText(this, "업로드 onPause", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onStop() {
        super.onStop();
        Toast.makeText(this, "업로드 onStop", Toast.LENGTH_SHORT).show();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Toast.makeText(this, "업로드 onDestroy", Toast.LENGTH_SHORT).show();
}
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Toast.makeText(this, "업로드 onActivityResult", Toast.LENGTH_SHORT).show();
    }
