...
public class SheetmusicActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        upload_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    ...
                    intent_requireLogin.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    intent_requireLogin.putExtra("액티비티","업로드");
                    startActivity(intent_requireLogin);
                }
            }
        });
        ...
        //아이템 클릭
        mAdapter.setOnItemClickListener(new Adapter_SheetmusicActivity.OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                ...
                Log.d(TAG, "onItemClick: 정보 넣기");
                startActivity(intent);
                Log.d(TAG, "onItemClick: 컨텐츠로 이동");
            }
        });
