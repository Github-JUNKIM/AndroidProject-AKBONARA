...
public class CommunityPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_community_post);  //layout xml 매칭
    ...
    protected void onResume() {
        ...
        for(int i=0;i<array_Article_Community.length();i++){
            try {
                final JSONObject a = (JSONObject) array_Article_Community.get(i);
...
//        }
        ...
        try {
            ...
            if(ID_NUMBER!=-1) {
                ...
                JSONArray likeList = currentClient.getJSONArray("글좋아요목록");
        ...
        //어댑터 생성
        mAdapter = new Adapter_Comment_SheetmusicActivity(2,Item_Comment_Sheetmusic_LIST,DATABASE,ArticleNumber,ID_NUMBER,preferences,
                this,new SheetmusicPostActivity(),new VideoPostActivity(),this);
        ...
        final Intent intent_requireLogin = new Intent(CommunityPostActivity.this,LoginActivity.class);
        ...
        악보나라.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_main = new Intent(CommunityPostActivity.this,MainActivity.class);
        ...
        button_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_mypage = new Intent(CommunityPostActivity.this, MypageActivity.class);
        ...
        button_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_alarm = new Intent(CommunityPostActivity.this, AlarmActivity.class);
        ...
        icon_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_sheetmusic = new Intent(CommunityPostActivity.this,SheetmusicActivity.class);
        ...
        icon_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_video = new Intent(CommunityPostActivity.this,VideoActivity.class);
        ...
        icon_community.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_community = new Intent(CommunityPostActivity.this,CommunityActivity.class);
        ...
        upload_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    ...
                    intent_requireLogin.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    intent_requireLogin.putExtra("액티비티","커뮤니티포스트");
                    startActivity(intent_requireLogin);
                }
                ...
                //회원일때
                    ...
                    try {
                        ...
                        //좋아요 취소하는 경우
                            ...
                            like_boolean = false;
                            Toast.makeText(CommunityPostActivity.this, "좋아요가 취소되었습니다.", Toast.LENGTH_SHORT).show();
                        }
        ...
        Edit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CommunityPostActivity.this,CommunityEditActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                intent.putExtra("악보넘버",ArticleNumber);
                Log.d("수정 게시글 넘버", "넘버는 "+ArticleNumber);
    ...
    //재실행
    public void update(){
        Intent intent_sheetmusic = new Intent(CommunityPostActivity.this, CommunityPostActivity.class);
        intent_sheetmusic.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        startActivity(intent_sheetmusic);
    }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            array_Article_Community.put(ArticleNumber,newjsonObject);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        Toast.makeText(CommunityPostActivity.this, "게시글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
