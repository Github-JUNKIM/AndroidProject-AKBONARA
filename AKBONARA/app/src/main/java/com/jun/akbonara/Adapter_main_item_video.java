...
public class Adapter_main_item_video extends RecyclerView.Adapter<Adapter_main_item_video.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView youtube_thumnail;
        ...
        public MyViewHolder(View v) {
            ...
            youtube_thumnail = v.findViewById(R.id.youtube_thumnail);
            videoname = v.findViewById(R.id.videoname);
            nickname = v.findViewById(R.id.nickname);
            uploadtime = v.findViewById(R.id.uploadtime);
    ...
    public Adapter_main_item_video(List<Item_VideoActivity> myDataset,JSONObject database,Context context,SharedPreferences preferences) {
        mDataset = myDataset;
        DATABASE = database;
    ...
    public Adapter_main_item_video.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
        ConstraintLayout v = (ConstraintLayout) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_item_video, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Item_VideoActivity item_videoActivity = mDataset.get(position);
        ...
        try {
            clientObj = array_client.getJSONObject(item_videoActivity.get아이디넘버());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            holder.nickname.setText(clientObj.getString("닉네임"));
            holder.videoname.setText(item_videoActivity.get글제목());

            //쉐어드에 데이터가 없거나 업데이트가 안되었다면
            if(ShardOrServer==1) {
                Picasso.get().load("https://img.youtube.com/vi/" + item_videoActivity.get동영상주소() + "/mqdefault.jpg").into(holder.youtube_thumnail);
            ...
            //쉐어드에 최신데이터가 있다면
                ...
                holder.youtube_thumnail.setImageURI(Uri.parse("/data/data/"+context.getPackageName()+"/app_images/"+videocode +".png"));
            ...
            holder.uploadtime.setText(timeCalculator.formatTimeString(item_videoActivity.get업로드시간()));
