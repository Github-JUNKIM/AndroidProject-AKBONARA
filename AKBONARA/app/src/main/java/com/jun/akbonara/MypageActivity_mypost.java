...
public class MypageActivity_mypost extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(Filter_Category==0){
            btn_profit.setVisibility(View.VISIBLE);
        }
        else{
            btn_profit.setVisibility(View.GONE);
        }
        ...
        final Intent intent_requireLogin = new Intent(MypageActivity_mypost.this,LoginActivity.class);
        ...
        악보나라.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_main = new Intent(MypageActivity_mypost.this,MainActivity.class);
        ...
        button_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_mypage = new Intent(MypageActivity_mypost.this, MypageActivity.class);
        ...
        button_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_alarm = new Intent(MypageActivity_mypost.this, AlarmActivity.class);
        ...
        icon_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_sheetmusic = new Intent(MypageActivity_mypost.this,SheetmusicActivity.class);
        ...
        icon_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_video = new Intent(MypageActivity_mypost.this,VideoActivity.class);
        ...
        icon_community.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_community = new Intent(MypageActivity_mypost.this,CommunityActivity.class);
        ...
        if(Filter_Category==0){
            ...
            if(SheetmusicArticleInfo.size()==0 ){
                NoLikePostMSG.setText("등록한 게시글이 없습니다");
        ...
        if(Filter_Category==0){
            ...
            SheetmusicAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(MypageActivity_mypost.this,SheetmusicPostActivity.class);
            ...
            adapter_videoActivity.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(MypageActivity_mypost.this,VideoPostActivity.class);
            ...
            adapter_communityActivity.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(MypageActivity_mypost.this,CommunityPostActivity.class);
        ...
        btn_profit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MypageActivity_mypost.this,MypageActivity_Profit.class);
                startActivity(intent);
            }
        });
