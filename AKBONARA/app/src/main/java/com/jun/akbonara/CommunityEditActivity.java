...
public class CommunityEditActivity extends AppCompatActivity {
    ...
    EditText ArticleName, editTextTextMultiLine;

    Button button00,button01,button02,button10,button11,button12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_community_upload);  //layout xml 매칭
        ...
        letter_register_article.setText("글 수정");
        ...
        if(ArticleNumber!=-1){
            try {
                thisArticle = array_Article_Community.getJSONObject(ArticleNumber);
                ...
                switch(selectedgenre){
                    case "Q & A" : button00.setBackgroundResource(R.drawable.checkcomplete); break;
                    case "곡추천" : button01.setBackgroundResource(R.drawable.checkcomplete); break;
                    case "피아노추천" : button02.setBackgroundResource(R.drawable.checkcomplete); break;
                    case "잡담" : button10.setBackgroundResource(R.drawable.checkcomplete); break;
                    case "자기소개" : button11.setBackgroundResource(R.drawable.checkcomplete); break;
                    case "건의사항" : button12.setBackgroundResource(R.drawable.checkcomplete); break;
                }
    ...
    protected void onResume() {
        ...
        final Intent intent_requireLogin = new Intent(CommunityEditActivity.this,LoginActivity.class);
        ...
        악보나라.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_main = new Intent(CommunityEditActivity.this,MainActivity.class);
        ...
        button_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_mypage = new Intent(CommunityEditActivity.this, MypageActivity.class);
        ...
        button_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_alarm = new Intent(CommunityEditActivity.this, AlarmActivity.class);
        ...
        icon_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_sheetmusic = new Intent(CommunityEditActivity.this,SheetmusicActivity.class);
        ...
        icon_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_video = new Intent(CommunityEditActivity.this,VideoActivity.class);
        ...
        icon_community.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_community = new Intent(CommunityEditActivity.this,CommunityActivity.class);
        ...
        button_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //업로드 절차
                if (uploadArticleName.equals("")  || Article.equals("")  || Genre.equals("")   ) {
                    Toast.makeText(CommunityEditActivity.this, "게시글 정보를 모두 등록해주세요.", Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        DATABASE.put("커뮤니티글정보", array_Article_Community);
                    ...
                    Toast.makeText(CommunityEditActivity.this, "게시글이 수정되었습니다.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CommunityEditActivity.this, CommunityActivity.class);
