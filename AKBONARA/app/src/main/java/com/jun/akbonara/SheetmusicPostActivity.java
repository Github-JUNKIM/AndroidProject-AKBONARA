...
public class SheetmusicPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preview_letter = findViewById (R.id.preview_letter);
    ...
    protected void onResume() {
        ...
        try {
            if(ID_NUMBER!=-1)
            for (int i = 0; i < currentClient.getJSONArray("구매한악보").length(); i++) {
                if (ArticleNumber == currentClient.getJSONArray("구매한악보").getInt(i)){
...
//        }
        ...
        //포스팅 내용 매칭
        try {
            thisArticle = (JSONObject) array_SheetmusicArticle.get(ArticleNumber);
            if(thisArticle.getString("프로필").equals("")){
                profile_1.setImageResource(R.drawable.ic_icon_basicprofile);
            }
            else{
                profile_1.setImageURI(Uri.parse(thisArticle.getString("프로필")));
            }

            nickname_1.setText(thisArticle.getString("닉네임"));
            ...
            //작성자이거나 구매자일때 악보 가시유무
            if(ID_NUMBER==thisArticle.getInt("아이디넘버") || alreadypurchase==true){
                preview_letter.setVisibility(View.GONE);
                pdfviewer.fromUri(Uri.parse(thisArticle.getString("악보"))).swipeHorizontal(true).load();
            }
            else{
                preview_letter.setVisibility(View.VISIBLE);
                pdfviewer.fromUri(Uri.parse(thisArticle.getString("악보"))).pages(0).load();
            }
            ...
            if(alreadypurchase==false) {
                if (thisArticle.getInt("가격") == 0) {
                    ...
                    price.setText("캐시  " + Integer.toString(thisArticle.getInt("가격")) + "원");
                }
            }
            else{
                price.setText("이미 구매한 악보입니다.");
                purchase_btn.setText("악보목록");
            }
            ...
            if(ID_NUMBER!=-1) {
                ...
                JSONArray likeList = currentClient.getJSONArray("좋아요목록");
        ...
        try {
            JSONObject thisarticle = array_SheetmusicArticle.getJSONObject(ArticleNumber);
        ...
        //어댑터 생성
        mAdapter = new Adapter_Comment_SheetmusicActivity(0,Item_Comment_Sheetmusic_LIST,DATABASE,ArticleNumber,ID_NUMBER,preferences,this,this,new VideoPostActivity(),new CommunityPostActivity());
        ...
        try {
            ...
            if(ID_NUMBER==-1){
                ...
                if(thisarticle.getInt("조회수")==0){
                    watchingPersonList.put(android_id);
                    thisarticle.put("조회수",watchingPersonList.length());
            ...
            number_of_hits.setText(Integer.toString(thisarticle.getInt("조회수")));
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        upload_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    ...
                    intent_requireLogin.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                    intent_requireLogin.putExtra("액티비티","악보포스트");
                    startActivity(intent_requireLogin);
                }
        ...
        AddComment_button.setOnClickListener(new View.OnClickListener() {
            ...
            try {
                ...
                JSONObject thisarticle = (JSONObject) array_SheetmusicArticle.get(ArticleNumber);
                ...
                holymoly.put(a);
                thisarticle.put("댓글수",holymoly.length());
                ...
                //회원일때
                    ...
                    try {
                        ...
                        if (like_boolean == false) {
                            ...
                            thisArticle.put("좋아요수",likeClientList.length());
                            like_boolean = true;
                        ...
                        //좋아요 취소하는 경우
                            ...
                            like_boolean = false;
                            Toast.makeText(SheetmusicPostActivity.this, "좋아요가 취소되었습니다.", Toast.LENGTH_SHORT).show();
                        }
        ...
        Edit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SheetmusicPostActivity.this,SheetmusicEditActivity.class);
        ...
        purchase_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //회원일때
                    ...
                    if(alreadypurchase==false) {
                        Intent intent = new Intent(SheetmusicPostActivity.this, PopupActivity.class);
                        intent.putExtra("아티클넘버", ArticleNumber);
                        startActivity(intent);
                    }
                    else if(alreadypurchase==true) {
                        Intent intent = new Intent(SheetmusicPostActivity.this, MypageActivity_purchase.class);
                        startActivity(intent);
                    }
                }
    ...
    //재실행
    public void update(){
        Intent intent_sheetmusic = new Intent(SheetmusicPostActivity.this,SheetmusicPostActivity.class);
        intent_sheetmusic.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        startActivity(intent_sheetmusic);
    }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            array_SheetmusicArticle.put(ArticleNumber,newjsonObject);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        Toast.makeText(SheetmusicPostActivity.this, "게시글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(SheetmusicPostActivity.this, SheetmusicActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        startActivity(intent);
                        finish();
