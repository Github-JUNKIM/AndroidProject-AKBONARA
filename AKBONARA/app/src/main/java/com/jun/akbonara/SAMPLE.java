...
public class SAMPLE extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        final Intent intent_requireLogin = new Intent(SAMPLE.this,LoginActivity.class);
        ...
        악보나라.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_main = new Intent(SAMPLE.this,MainActivity.class);
        ...
        button_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_mypage = new Intent(SAMPLE.this, MypageActivity.class);
        ...
        button_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_alarm = new Intent(SAMPLE.this, AlarmActivity.class);
        ...
        icon_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_sheetmusic = new Intent(SAMPLE.this,SheetmusicActivity.class);
        ...
        icon_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_video = new Intent(SAMPLE.this,VideoActivity.class);
        ...
        icon_community.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_community = new Intent(SAMPLE.this,CommunityActivity.class);
