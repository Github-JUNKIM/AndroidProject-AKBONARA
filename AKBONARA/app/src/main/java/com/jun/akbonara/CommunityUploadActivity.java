...
public class CommunityUploadActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        final Intent intent_requireLogin = new Intent(CommunityUploadActivity.this,LoginActivity.class);
        ...
        악보나라.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_main = new Intent(CommunityUploadActivity.this,MainActivity.class);
        ...
        button_mypage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_mypage = new Intent(CommunityUploadActivity.this, MypageActivity.class);
        ...
        button_alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ID_NUMBER!=-1) {
                    Intent intent_alarm = new Intent(CommunityUploadActivity.this, AlarmActivity.class);
        ...
        icon_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_sheetmusic = new Intent(CommunityUploadActivity.this,SheetmusicActivity.class);
        ...
        icon_video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_video = new Intent(CommunityUploadActivity.this,VideoActivity.class);
        ...
        icon_community.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_community = new Intent(CommunityUploadActivity.this,CommunityActivity.class);
        ...
        button_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (uploadArticleName.equals("")  || Article.equals("")  || Genre.equals("")   ) {
                    Toast.makeText(CommunityUploadActivity.this, "게시글 정보를 모두 등록해주세요.", Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        array_Article_Community.put(article);
                    ...
                    Toast.makeText(CommunityUploadActivity.this, "게시글이 등록되었습니다.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CommunityUploadActivity.this, CommunityActivity.class);
